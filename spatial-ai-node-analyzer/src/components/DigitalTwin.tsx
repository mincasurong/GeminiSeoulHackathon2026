...
import { SpatialNode, ObjectLocation } from '../services/gemini';
  ...
  useEffect(() => {
    if (meshRef.current && voxelData.length > 0) {
      ...
      voxelData.forEach((voxel, i) => {
        ...
        // Add a tiny gap between voxels (0.85 multiplier)
  ...
  return (
    <>
      ...
      {locations.map((loc) => {
        ...
        const h = isStatic ? 2.5 : 1.5; // Taller than voxels to be visible and clickable
...
export default function DigitalTwin(props: DigitalTwinProps) {
  return (
    <div className="w-full h-full bg-[#0a0a0a] relative">
      ...
      {/* Legend */}
      <div className="absolute bottom-4 left-4 bg-[#111]/80 backdrop-blur border border-[#333] p-3 rounded-lg text-[10px] font-mono text-[#888] flex flex-col gap-2 pointer-events-none">
