...
export default function InteriorMapComponent({ mapImage, locations, topology, sourceImages, selectedObjectId, onSelectObject, theme }: InteriorMapProps) {
    ...
    return (
        <div className="w-full h-full relative">
            ...
            <button onClick={handleDownload}
                className="absolute top-3 right-3 z-20 flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-mono font-bold transition-all hover:scale-105"
